  ...
  <div v-wechat-title="title" class="newConsul">
    ...
    <div class="backgroundStyle">
      ...
      <div-selector :tilteValue="'手术中角色'" :dictCode="'SSJS'"
                    ...
                    :anyData="crInfo.operativeRole"></div-selector>
      <div-selector :tilteValue="'手术名称'" :dictCode="'SSMC'"
                    v-on:listenSelect="(value) => {crInfo.operationName = value.code}"
                    :anyData="crInfo.operationName"></div-selector>
      <div-selector :tilteValue="'会诊地点'" :dictCode="'YYXX'"
                    v-on:listenSelect="(value) => {crInfo.operationLocal = value.code}"
                    :anyData="crInfo.operationLocal"></div-selector>
