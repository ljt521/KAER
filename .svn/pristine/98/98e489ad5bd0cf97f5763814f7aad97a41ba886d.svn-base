      ...
      <swipeout-item transition-mode="follow" class="fo-tex"  v-for="(lectureInfo,index) in LectureInfoData" :key="index">
        ...
        <div slot="content" :class="{'vux-1px-b': index !== LectureInfoData.length}" >
            ...
            <p style="margin: 10px 0">
              <icon class="cu-img-size" style="color: #888888;font-size: 15px;margin-left: -2px;padding-right: 13px;" type="waiting-circle"></icon>
              <span>{{lectureInfo.lessonDate|formatDate}}</span>
            </p>
            <p style="margin: 10px 0">
              <span class="right">
